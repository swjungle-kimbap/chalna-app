...
export const urls = {
    ...
    ADD_KEYWORD_URL: getFullUrl(Config.APP_SETTING_KEYWORD_PATH),
    DELETE_KEYWORD_URL: getFullUrl(Config.APP_SETTING_KEYWORD_PATH),
    DELETE_ALL_KEYWORDS_URL: getFullUrl(Config.APP_SETTING_KEYWORD_PATH),

    GET_RELATION_URL: getFullUrl(Config.RELATION_PATH),
    SET_RELATION_CNT_URL: getFullUrl(Config.RELATION_PATH),
    FRIEND_QUERY_URL: getFullUrl(Config.RELATION_PATH),


    ACCEPT_FRIEND_REQUEST_URL: getFullUrl(Config.FRIEND_ACCEPT_PATH),
    REJECT_FRIEND_REQUEST_URL: getFullUrl(Config.FRIEND_REJECT_PATH),
    DELETE_FRIEND_URL: getFullUrl(Config.RELATION_DELETE_PATH),
    BLOCK_FRIEND_URL: getFullUrl(Config.RELATION_BLOCK_PATH),
    UNBLOCK_FRIEND_URL: getFullUrl(Config.RELATION_UNBLOCK_PATH),

    GET_FRIEND_LIST_URL: getFullUrl(Config.FRIEND_PATH),
    SENT_FRIEND_REQUEST_URL: getFullUrl(Config.FRIEND_SENT_REQUEST_PATH),
    RECEIVED_FRIEND_REQUEST_URL : getFullUrl(Config.FRIEND_RECEIVED_REQUEST_PATH),
    SEND_FRIEND_REQUEST_URL: getFullUrl(Config.FRIEND_REQUEST_PATH),
